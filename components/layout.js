    ...
    return(
      ...
      <div className='mobile-menu'>
        <ul>          
          ...
          <li><Link href="/"><a className="block text-sm px-2 py-4 transition duration-300 hover:bg-blue-500"> Projects</a></Link></li>
          <li><Link href="/"><a className="block text-sm px-2 py-4 transition duration-300 hover:bg-blue-500"> Certificates</a></Link></li>            
        </ul>
      </div>
    )
  }
        ...
        <div className="cont mx-auto px-4">
          ...
          <div className="flex justify-between">
            ...
            <div className="items-center hidden md:flex">
              ...
              <Link href='/'><a className="py-4 px-2 text-gray-900 font-semibold transition duration-300 hover:text-blue-500">Projects</a></Link>
              <Link href='/'><a className="py-4 px-2 text-gray-900 font-semibold transition duration-300 hover:text-blue-500">Certificates</a></Link>
