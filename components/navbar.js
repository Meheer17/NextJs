        ...
        <div className="cont mx-auto px-4">
          ...
          <div className="flex justify-between">
            ...
            <div className="items-center hidden md:flex">
              ...
              <Link href='/certificate-post'><a className="py-4 px-2 font-semibold transition duration-300 bg-sky-300 text-gray-900 rounded-lg hover:text-blue-500">New Post</a></Link>
