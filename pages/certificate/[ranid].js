        ...
        <>
           ...
           <section className='py-32 mx-auto max-w-3xl p-4'>
             ...
             <div className='pt-20 justify-between flex'>
               ...
               {name ? <Link href={`/${details._id}/edit-certificate`}><a className="bg-black duration-300 hover:text-black hover:bg-white m-2 text-white p-4 rounded-lg w-full  text-center"><FontAwesomeIcon className='mr-2' icon={faPenToSquare} />Edit</a></Link> : null}
             </div>
           </section>
        </>
       )
