          ...
          return (
            <div data-aos="fade-up" data-aos-delay="100">
              <Link href={`/certificate/${pr.ranid}`}>
                <div key={pr._id} className="bg-gray-900 rounded-xl hover:cursor-pointer w-full hover:scale-110 duration-200 text-white hover:text-sky-400 z-10 hover:z-30">
