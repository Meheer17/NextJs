    ...
    return <>
       ...
       <section className='py-32 mx-auto max-w-3xl p-4'>
         ...
         <div className='pt-20 justify-between flex'>
           {details.link ? <div className=' bg-black hover:cursor-pointer duration-300 hover:text-black hover:bg-white m-2 text-white p-4 rounded-lg w-full text-center'><Link
             href={details.link}
             target={"_blank"}>
              <FontAwesomeIcon className='mr-2' icon={faLink} />View</Link></div> : null}
           {name ? <div className='bg-black hover:cursor-pointer duration-300 hover:text-black hover:bg-white m-2 text-white p-4 rounded-lg w-full text-center'><Link
             href={`/${details._id}/edit-projects`}>
              <FontAwesomeIcon className='mr-2' icon={faPenToSquare} />Edit</Link></div> : null}
           {details.github ? <div className='bg-black hover:cursor-pointer duration-300 hover:text-black hover:bg-white m-2 text-white p-4 rounded-lg w-full text-center'><Link
             href={details.github}
             target={"_blank"}>
              <FontAwesomeIcon className='mr-2' icon={faGithub} />GitHub</Link></div> : null}
         </div>
       </section>
    </>;
