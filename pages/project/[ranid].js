       ...
       <section className='py-32 mx-auto max-w-3xl p-4'>
         ...
         <div className='pt-20 justify-between flex'>
           {details.link ? <Link
             ...
             ><div><FontAwesomeIcon className='mr-2 h-7' icon={faLink} />View<div/></Link> : null}
           {name ? <Link
             href={`/${details._id}/edit-projects`}
             className="bg-black hover:cursor-pointer duration-300 hover:text-black hover:bg-white m-2 text-white p-4 rounded-lg w-full  text-center"
             ><div><FontAwesomeIcon className='mr-2 h-7' icon={faPenToSquare} />Edit<div/></Link> : null}
           {details.github ? <Link
             href={details.github}
             target={"_blank"}
             className="bg-black hover:cursor-pointer duration-300 hover:text-black hover:bg-white m-2 text-white p-4 rounded-lg w-full text-center "
             ><div><FontAwesomeIcon className='mr-2 h-7' icon={faGithub} />GitHub<div/></Link> : null}
         </div>
       </section>
    </>;
